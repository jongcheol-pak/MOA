...
///
/// **2026-08-21 정정**: 종전 주석은 "egui가 끌고 있는 항목을 이미 커서에 붙여 보인다"고
/// 적었으나 사실이 아니다 — egui는 페이로드를 세워도 커서 아이콘만 `Grabbing`으로 바꾼다
/// (`egui::DragAndDrop`의 `on_end_pass`). 그림은 이제 앱이 직접 그린다.
///
