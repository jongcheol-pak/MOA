...
- [2026-07-28] 워크스페이스 Delete 키 배정 — egui에 영역 포커스 개념이 없어 전역 Delete를 받으면 파일 목록에서도 워크스페이스가 지워진다. 키 미배정 + 메뉴 표기 제거로 처리했고, 영역별 포커스 도입 시 되살린다. F2도 같은 성질 (출처: 2026-07-26-egui-migration-part2 F-7 M2)
